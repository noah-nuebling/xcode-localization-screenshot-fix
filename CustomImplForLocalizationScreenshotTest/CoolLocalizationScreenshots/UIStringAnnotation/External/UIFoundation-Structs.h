...
@class NSTextContainer, /*<NSTextLocation>,*/ NSTextRange, NSString, NSFont, NSMutableParagraphStyle;
...
typedef struct UINibDecoderValue {
    ...
    /// Copied this from somewhere off github
